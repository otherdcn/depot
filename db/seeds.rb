...
Product.create!(title: 'Docker for Rails Developers',
  description:
    %{<p>
      ...
      Docker does for DevOps what Rails did for web developmentâit gives you 
      a new set of superpowers. Gone are âworks on my machineâ woes and lengthy 
      ...
      Gain hands-on, real-world experience with a tool thatâs rapidly becoming 
...
Product.create!(title: 'Build Chatbot Interactions',
  description:
    %{<p>
      ...
      for users. Take advantage of the Lita frameworkâs step-by-step 
